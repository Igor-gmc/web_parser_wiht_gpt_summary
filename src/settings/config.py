...
class settings:
    ...
    ENABLE_FULLTEXT = True # опционально: читать полностью статью или только превью
    ...
    def OUTPUT_PATH(self) -> Path:
        return self.WORKDIR / self.OUTPUT_NAME # полный путь к готовому файлу с обработанными данными
